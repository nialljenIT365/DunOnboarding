...
# Helper Functions
# ============================================================================
# Helper function to return a boolen True/Falue check if the logged in User is Global Admin in IDE
...
# Helper function to return a boolen True/Falue check if the logged in User is Global Admin in CloudShell
