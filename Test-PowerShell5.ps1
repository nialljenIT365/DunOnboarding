# ============================================================================
# Secure Secret Upload POC - End-to-End Test (PowerShell 5.1 Compatible)
# ============================================================================
# This script tests the complete flow from a Windows PowerShell 5.1 environment
# using RSACng for RSA-OAEP-SHA256 encryption.
# ============================================================================
...
try {
    ...
    Write-Host "    Debug: Key length = $($publicKeyBytes.Length) bytes" -ForegroundColor Gray
    Write-Host "    Debug: First byte = 0x$($publicKeyBytes[0].ToString('X2'))" -ForegroundColor Gray
    
    # Parse the SubjectPublicKeyInfo format to extract modulus and exponent
    $rsaParams = Parse-SubjectPublicKeyInfo $publicKeyBytes
    
    # Create RSA object using RSACng (supports SHA-256)
    ...
    # Encrypt the secret using OAEP with SHA256
    ...
    Write-Host "  [OK] Secret encrypted successfully" -ForegroundColor Green
